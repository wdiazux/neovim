...
with lib.plusultra;
with lib.plusultra.theme.catppuccin-mocha; let
  bufferline-buffer-text = color6;
  bufferline-buffer-background = color1;
  bufferline-buffer-focus-text = color6;
  bufferline-buffer-focus-background = color3;
in {
